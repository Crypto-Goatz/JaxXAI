...
export default function TypingPromptInput() {
  const prompts = [
    "What's the sentiment around Bitcoin right now?",
    "Show me the best entry point for ETH...",
    "Analyze whale movements in the last 24 hours...",
    "Set up an automated bot for swing trading...",
    "Is this rumor about the SEC and XRP true?",
  ]
    ...
    <div className="relative w-full max-w-2xl mx-auto px-4 sm:px-0">
      <div className="relative group">
        ...
        <div className="relative">
          <Input
            className="pr-14 sm:pr-20 py-4 sm:py-6 text-sm sm:text-base rounded-xl backdrop-blur-md border-2 focus-visible:ring-0 focus-visible:ring-offset-0 
