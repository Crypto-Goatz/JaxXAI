...
export default function ContactForm() {
  ...
  if (isSubmitted) {
    return (
      <Card>
        <CardContent className="pt-6 flex flex-col items-center justify-center min-h-[300px] sm:min-h-[400px] text-center px-4">
  ...
  return (
    <Card>
      <CardHeader>
        <CardTitle className="text-lg sm:text-xl">Contact Our Enterprise Team</CardTitle>
