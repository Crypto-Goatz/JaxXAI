...
export default function Navbar() {
  ...
  const navItems = [
    ...
    { label: "Automated Trader", href: "/use-cases/automated-trader" },
    ...
    <header className="sticky top-0 z-50 w-full border-b bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/60">
      <div className="container flex h-16 items-center justify-between">
        <div className="flex items-center gap-2">
          <Link href="/" className="flex items-center space-x-2" aria-label="Jax Homepage">
            <span className="text-2xl font-bold">Jax</span>
          </Link>
        </div>
        ...
        <div className="flex items-center gap-4">
          ...
          <Button asChild variant="outline" className="hidden md:flex items-center gap-2 bg-transparent">
            <Link href="/dashboard">
